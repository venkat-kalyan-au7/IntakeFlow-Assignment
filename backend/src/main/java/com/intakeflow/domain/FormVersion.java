...
@Table(
    name = "form_versions",
    uniqueConstraints = @UniqueConstraint(columnNames = {"form_id", "version_number"}))
public class FormVersion {
  ...
  public void setForm(FormDefinition v) {
    form = v;
  }
  ...
  public void setStatus(FormVersionStatus v) {
    status = v;
  }
  ...
  public void setFields(Set<FormField> v) {
    fields = v;
  }
}
